...
TEAM_ID="TEAMID0000"  # organisation team ID
DEVELOPER_ID_APP_HASH="C0277EBA633F1AA2BC2855E45B3B38A1840053BA"
APPLE_DEV_ID="Apple Development: Developer Name (TEAMID0001)"
...
EOF
    ...
    if [ "$DISTRIBUTION" = true ]; then
        ...
        productsign --sign "Developer ID Installer: Organisation Name (${TEAM_ID})" \
            "${DIST_DIR}/${PKG_NAME}" \
            "${SIGNED_PKG}"
